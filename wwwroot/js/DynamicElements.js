...
function dyn(type, attStr, appnd) {
    try {
        ...
        var icon = "", iAttr = "", iHTML = "", iid = "", iClass = "", xClass = "", iSize = "", iiSize = "", iBorder = "", iClick = "", id = "", iStyle = "";
...
//main.appendChild(dyn("label", "icon=mailbox.png|Mailbox"));

//section("divMain", [
//	"label|icon=mailbox.png|onclick=openMailbox()|Mailbox",
//	"label|icon=calendar.png|onclick=openCalendar|Calendar"
//]);
